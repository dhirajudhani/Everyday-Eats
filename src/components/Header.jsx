...
const Header = () => {
  return (
    <>
      <header className="shadow-md w-full fixed left-0 top-0 right-0 h-20 z-10 md:px-5 bg-white px-3">
        <div className="flex justify-between items-center h-full container mx:auto">
          <div className="flex items-center md:gap-5 gap-2">
            ...
            <button className="md:flex items-center gap-2 group sidebar-btn hidden">
              <span className="custom-underline relative text-sm group-hover:text-color-2">Other</span>
              userLocation
              <span className="text-color-2 text-xl">
                <IoIosArrowDown />
              </span>
            </button>
            <button className="md:hidden flex gap-1 items-center text-color-1">
          ...
          <ul className="flex items-center md:gap-5 gap-4">
            <button className="flex items-center gap-2 group hover:text-color-2">
              <div>
                <svg
